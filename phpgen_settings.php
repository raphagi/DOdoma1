...
{
    $result = array();
    $result[] = array('caption' => 'Citizen', 'short_caption' => 'Citizen', 'filename' => 'citizen.php', 'name' => 'citizen', 'group_name' => 'Default', 'add_separator' => false, 'description' => '');
    return $result;
}
